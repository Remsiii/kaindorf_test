...
public class CameraController : MonoBehaviour
{
    ...
    public Vector2 margin = new Vector2(0.5f, 1); // If the player stays inside this margin, the camera won't move.
    public Vector2 smoothing = new Vector2(9, 9); // The bigger the value, the faster is the camera.
    ...
    void Update()
    {
        ...
        var y = transform.position.y + 0.04f;
